...
icon = Image.open("C:/Users/Mohan.S/Desktop/Mohan_Project/Project3/1.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By MS",                
                   page_icon= icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *MS*!"""})
...
selected = option_menu(None, ["Home","Upload & Extract","Modify"],
                       icons=["house","upload","pencil-square"],
                       default_index=0,
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:/Users/Mohan.S/Desktop/Mohan_Project/Project3/2.png"),width=500)
        st.markdown("## :green[**Technologies Used :**] Python,easy OCR, Streamlit, psycopg2, Pandas")
    with col2:
